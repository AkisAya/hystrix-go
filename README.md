...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/akisaya/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/akisaya/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/akisaya/hystrix-go```
- ```go test ./...```
